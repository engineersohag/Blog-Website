...
?>
	...
	<div class="container mt-2">
		<div class="row">
			<h3 class="py-3 rounded-1 mb-0" style="background: rgba(0, 0, 0, .2);">Search result for: <span class="text-primary"><?= $keyword ?></span></h3>
			<div class="col-lg-8">
				<hr>
				<?php  
				if($rows){
				...
				<?php } }else{
					echo "<h5 class='text-danger'>No Recode Found!!</h5>
					<b>Suggestions:</b>
					<ul>
					<li>Make sure that words are spelled correctly.</li>
					<li>Try different keyword.</li></ul>";
				} ?>
				<!-- --- Pagination Start --- -->
				<?php  
